...
sf_5.simulateNsave('NS_P45_Fitness_SF_E500_Mito_N500.csv', 20*1000, model ='WF', asex_type='mitosis',sex_freq=500,random_mating=False,strides=1)


save_object(sf_5.sex_gen, 'NS_P45_SF_E500_Mito_SEX_GEN')
save_object(sf_5.sex_mean_fit, 'NS_P45_SF_E500_Mito_SEX_POP_MFIT')
save_object(sf_5.germ_mutations, 'NS_P45_SF_E500_Mito_Germ_Pop_Mutations')
save_object(sf_5.soma_mutations, 'NS_P45_SF_E500_Mito_Soma_Pop_Mutations')

save_object(sf_5.slope_list_1, 'NS_P45_SF_E500_Mito_100G_SLOPE')
save_object(sf_5.slope_list_2, 'NS_P45_SF_E500_Mito_500G_SLOPE')
save_object(sf_5.slope_list_3, 'NS_P45_SF_E500_Mito_1KG_SLOPE')
save_object(sf_5.slope_list_4, 'NS_P45_SF_E500_Mito_2KG_SLOPE')
save_object(sf_5.slope_list_5, 'NS_P45_SF_E500_Mito_5KG_SLOPE')
save_object(sf_5.slope_list_6, 'NS_P45_SF_E500_Mito_10KG_SLOPE')
...
rm_5.simulateNsave('NS_P45_Fitness_RM_E500_Mito_N500.csv', 20*1000, model ='WF', asex_type='mitosis',sex_freq=500,random_mating=True,strides=1)


save_object(rm_5.sex_gen, 'NS_P45_RM_E500_Mito_SEX_GEN')
save_object(rm_5.sex_mean_fit, 'NS_P45_RM_E500_Mito_SEX_POP_MFIT')

save_object(rm_5.germ_mutations, 'NS_P45_RM_E500_Mito_Germ_Mutations')
save_object(rm_5.soma_mutations, 'NS_P45_RM_E500_Mito_Soma_Mutations')


save_object(rm_5.slope_list_1, 'NS_P45_RM_E500_Mito_100G_SLOPE')
save_object(rm_5.slope_list_2, 'NS_P45_RM_E500_Mito_500G_SLOPE')
save_object(rm_5.slope_list_3, 'NS_P45_RM_E500_Mito_1KG_SLOPE')
save_object(rm_5.slope_list_4, 'NS_P45_RM_E500_Mito_2KG_SLOPE')
save_object(rm_5.slope_list_5, 'NS_P45_RM_E500_Mito_5KG_SLOPE')
save_object(rm_5.slope_list_6, 'NS_P45_RM_E500_Mito_10KG_SLOPE')
