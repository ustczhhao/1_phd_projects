...
class Populations(object):
    ...
    def __init__(self,nReps,nInds,nLoci,ploidy=45, soma_genomic_mu =0.1, germ_genomic_mu=0.1,selcoef=0.1, mutate_freq =1, model_version ='ADD'):
        ...
        self.soma_mu = soma_genomic_mu/(nLoci*ploidy*mutate_freq)
        self.germ_mu = germ_genomic_mu/(nLoci*2)
        self.selcoef = selcoef
        self.current_step = 0

        self.mfit_before_mut = []
    ...
    def mutate_all_before(self):
        ...
        if self.current_step%self.mutate_freq ==0:
            # print "GM_B", self.current_step
            wt_germ = 2 - self.germ
            germ_mutations = np.random.binomial(wt_germ,self.germ_mu)
            self.germ += germ_mutations   

        wt_soma = self.ploidy - self.soma
        soma_mutations = np.random.binomial(wt_soma,self.soma_mu)
        self.soma += soma_mutations
        # print 'SM_B', self.current_step
        return
...
rm_5 =Populations(nReps =100, nInds =500, nLoci =100, ploidy =45, soma_genomic_mu =22.5, germ_genomic_mu=1, selcoef =0.1, mutate_freq =500, model_version ='MUL')
rm_5.simulateNsave('New_SMU225_GMU1_Fit_P45_RM_E500.csv', 20*1000, model ='WF', asex_type='amitosis', sex_freq=500,random_mating=True,strides=1)


save_object(rm_5.sex_gen, 'New_SMU225_P45_RM_SEX_GEN_E500')
save_object(rm_5.sex_mean_fit, 'New_SMU225_P45_RM_SEX_POP_MFIT_E500')

save_object(rm_5.mfit_before_mut, 'New_SMU225_P45_RM_MFIT_BF_MUT_E500')

save_object(rm_5.germ_mutations, 'New_SMU225_P45_RM_Germ_MT_E500')
save_object(rm_5.soma_mutations, 'New_SMU225_P45_RM_Soma_MT_E500')

save_object(rm_5.slope_list_1, 'New_SMU225_P45_RM_100G_SP_E500')
save_object(rm_5.slope_list_2, 'New_SMU225_P45_RM_500G_SP_E500')
save_object(rm_5.slope_list_3, 'New_SMU225_P45_RM_1KG_SP_E500')
save_object(rm_5.slope_list_4, 'New_SMU225_P45_RM_2KG_SP_E500')
save_object(rm_5.slope_list_5, 'New_SMU225_P45_RM_5KG_SP_E500')
save_object(rm_5.slope_list_6, 'New_SMU225_P45_RM_10KG_SP_E500')



sf_5 =Populations(nReps =100, nInds =500, nLoci =100, ploidy =45, soma_genomic_mu =22.5, germ_genomic_mu=1, selcoef =0.1, mutate_freq =500, model_version ='MUL')
sf_5.simulateNsave('New_SMU225_GMU1_Fit_P45_SF_E500.csv', 20*1000, model ='WF', asex_type='amitosis', sex_freq=500,random_mating=False,strides=1)


save_object(sf_5.sex_gen, 'New_SMU225_P45_SF_SEX_GEN_E500')
save_object(sf_5.sex_mean_fit, 'New_SMU225_P45_SF_SEX_POP_MFIT_E500')

save_object(sf_5.mfit_before_mut, 'New_SMU225_P45_SF_MFIT_BF_MUT_E500')

save_object(sf_5.germ_mutations, 'New_SMU225_P45_SF_Germ_MT_E500')
save_object(sf_5.soma_mutations, 'New_SMU225_P45_SF_Soma_MT_E500')

save_object(sf_5.slope_list_1, 'New_SMU225_P45_SF_100G_SP_E500')
save_object(sf_5.slope_list_2, 'New_SMU225_P45_SF_500G_SP_E500')
save_object(sf_5.slope_list_3, 'New_SMU225_P45_SF_1KG_SP_E500')
save_object(sf_5.slope_list_4, 'New_SMU225_P45_SF_2KG_SP_E500')
save_object(sf_5.slope_list_5, 'New_SMU225_P45_SF_5KG_SP_E500')
save_object(sf_5.slope_list_6, 'New_SMU225_P45_SF_10KG_SP_E500')