...
class Populations(object):
    ...
    def simulate(self,stepcount,model='M',asex_type='amitosis',mutate_freq = None, sex_freq=None,random_mating=False,strides=10):
        ...
        while self.current_step <= stepcount:
            ...
            if (mutate_freq !=None) and (self.current_step%mutate_freq ==0):
                fit_before_mut = self.fitness()
                pop_mfit_before_mut = np.nanmean(fit_before_mut, axis =1)
                self.mfit_before_mut.append(pop_mfit_before_mut)
    ...
    def simulateNsave(self,outfile, stepcount,model='M',asex_type='amitosis',mutate_freq = None, sex_freq=None,random_mating=False,strides=10):
        """same as simulate method except results are written to the file specified by outfile"""
        results = self.simulate(stepcount,model,asex_type,mutate_freq, sex_freq,random_mating,strides)
...
rm_5 =Populations(nReps =100, nInds =500, nLoci =100, ploidy =45, germ_genomic_mu=1, selcoef =0.1, model_version ='MUL')
rm_5.simulateNsave('Contr4_Fit_P45_RM_E500_10GMU.csv', 20*1000, model ='WF', asex_type='amitosis', mutate_freq =500, sex_freq=500,random_mating=True,strides=1)


save_object(rm_5.sex_gen, 'Contr4_P45_RM_SEX_GEN_E500')
save_object(rm_5.sex_mean_fit, 'Contr4_P45_RM_SEX_POP_MFIT_E500')

save_object(rm_5.mfit_before_mut, 'Contr4_P45_RM_MFIT_BF_MUT_E500')

save_object(rm_5.germ_mutations, 'Contr4_P45_RM_Germ_MT_E500')
save_object(rm_5.soma_mutations, 'Contr4_P45_RM_Soma_MT_E500')

save_object(rm_5.slope_list_1, 'Contr4_P45_RM_100G_SP_E500')
save_object(rm_5.slope_list_2, 'Contr4_P45_RM_500G_SP_E500')
save_object(rm_5.slope_list_3, 'Contr4_P45_RM_1KG_SP_E500')
save_object(rm_5.slope_list_4, 'Contr4_P45_RM_2KG_SP_E500')
save_object(rm_5.slope_list_5, 'Contr4_P45_RM_5KG_SP_E500')
save_object(rm_5.slope_list_6, 'Contr4_P45_RM_10KG_SP_E500')



sf_5 =Populations(nReps =100, nInds =500, nLoci =100, ploidy =45, germ_genomic_mu=1, selcoef =0.1, model_version ='MUL')
sf_5.simulateNsave('Contr4_Fit_P45_SF_E5_10GMU.csv', 20*1000, model ='WF', asex_type='amitosis', mutate_freq =500, sex_freq=500,random_mating=False,strides=1)


save_object(sf_5.sex_gen, 'Contr4_P45_SF_SEX_GEN_E500')
save_object(sf_5.sex_mean_fit, 'Contr4_P45_SF_SEX_POP_MFIT_E500')

save_object(sf_5.mfit_before_mut, 'Contr4_P45_SF_MFIT_BF_MUT_E500')

save_object(sf_5.germ_mutations, 'Contr4_P45_SF_Germ_MT_E500')
save_object(sf_5.soma_mutations, 'Contr4_P45_SF_Soma_MT_E500')

save_object(sf_5.slope_list_1, 'Contr4_P45_SF_100G_SP_E500')
save_object(sf_5.slope_list_2, 'Contr4_P45_SF_500G_SP_E500')
save_object(sf_5.slope_list_3, 'Contr4_P45_SF_1KG_SP_E500')
save_object(sf_5.slope_list_4, 'Contr4_P45_SF_2KG_SP_E500')
save_object(sf_5.slope_list_5, 'Contr4_P45_SF_5KG_SP_E500')
save_object(sf_5.slope_list_6, 'Contr4_P45_SF_10KG_SP_E500')
