...
rm_5 =Populations(nReps =100, nInds =500, nLoci =100, ploidy =45, germ_genomic_mu=0.002, selcoef =0.1, model_version ='MUL')
rm_5.simulateNsave('P45_Fitness_RM_N500_GMU0002_E500.csv', 20*1000, model ='WF', asex_type='amitosis',sex_freq=500,random_mating=True,strides=1)


save_object(rm_5.sex_gen, 'P45_RM_SEX_GEN_GMU0002_E500')
save_object(rm_5.sex_mean_fit, 'P45_RM_SEX_POP_MFIT_GMU0002_E500')

save_object(rm_5.germ_mutations, 'P45_RM_Germ_MU_GMU0002_E500')
save_object(rm_5.soma_mutations, 'P45_RM_Soma_MU_GMU0002_E500')


save_object(rm_5.slope_list_1, 'P45_RM_100G_SP_GMU0002_E500')
save_object(rm_5.slope_list_2, 'P45_RM_500G_SP_GMU0002_E500')
save_object(rm_5.slope_list_3, 'P45_RM_1KG_SP_GMU0002_E500')
save_object(rm_5.slope_list_4, 'P45_RM_2KG_SP_GMU0002_E500')
save_object(rm_5.slope_list_5, 'P45_RM_5KG_SP_GMU0002_E500')
save_object(rm_5.slope_list_6, 'P45_RM_10KG_SP_GMU0002_E500')




sf_5 =Populations(nReps =100, nInds =500, nLoci =100, ploidy =45, germ_genomic_mu=0.002, selcoef =0.1, model_version ='MUL')
sf_5.simulateNsave('P45_Fitness_SF_N500_GMU0002_E500.csv', 20*1000, model ='WF', asex_type='amitosis',sex_freq=500,random_mating=False,strides=1)


save_object(sf_5.sex_gen, 'P45_SF_SEX_GEN_GMU0002_E500')
save_object(sf_5.sex_mean_fit, 'P45_SF_SEX_POP_MFIT_GMU0002_E500')

save_object(sf_5.germ_mutations, 'P45_SF_Germ_MU_GMU0002_E500')
save_object(sf_5.soma_mutations, 'P45_SF_Soma_MU_GMU0002_E500')


save_object(sf_5.slope_list_1, 'P45_SF_100G_SP_GMU0002_E500')
save_object(sf_5.slope_list_2, 'P45_SF_500G_SP_GMU0002_E500')
save_object(sf_5.slope_list_3, 'P45_SF_1KG_SP_GMU0002_E500')
save_object(sf_5.slope_list_4, 'P45_SF_2KG_SP_GMU0002_E500')
save_object(sf_5.slope_list_5, 'P45_SF_5KG_SP_GMU0002_E500')
save_object(sf_5.slope_list_6, 'P45_SF_10KG_SP_GMU0002_E500')
