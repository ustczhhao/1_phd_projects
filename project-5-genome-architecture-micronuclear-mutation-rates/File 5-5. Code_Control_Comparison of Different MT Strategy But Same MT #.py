...
rm_5 =Populations(nReps =100, nInds =500, nLoci =100, ploidy =45, germ_genomic_mu=50, selcoef =0.1, model_version ='MUL')
rm_5.simulateNsave('Contr2_Fit_P45_RM_E500.csv', 20*1000, model ='WF', asex_type='amitosis', mutate_freq =500, sex_freq=500,random_mating=True,strides=1)


save_object(rm_5.sex_gen, 'Contr2_P45_RM_SEX_GEN_E500')
save_object(rm_5.sex_mean_fit, 'Contr2_P45_RM_SEX_POP_MFIT_E500')

save_object(rm_5.mfit_before_mut, 'Contr2_P45_RM_MFIT_BF_MUT_E500')

save_object(rm_5.germ_mutations, 'Contr2_P45_RM_Germ_MT_E500')
save_object(rm_5.soma_mutations, 'Contr2_P45_RM_Soma_MT_E500')

save_object(rm_5.slope_list_1, 'Contr2_P45_RM_100G_SP_E500')
save_object(rm_5.slope_list_2, 'Contr2_P45_RM_500G_SP_E500')
save_object(rm_5.slope_list_3, 'Contr2_P45_RM_1KG_SP_E500')
save_object(rm_5.slope_list_4, 'Contr2_P45_RM_2KG_SP_E500')
save_object(rm_5.slope_list_5, 'Contr2_P45_RM_5KG_SP_E500')
save_object(rm_5.slope_list_6, 'Contr2_P45_RM_10KG_SP_E500')



sf_5 =Populations(nReps =100, nInds =500, nLoci =100, ploidy =45, germ_genomic_mu=50, selcoef =0.1, model_version ='MUL')
sf_5.simulateNsave('Contr2_Fit_P45_SF_E500.csv', 20*1000, model ='WF', asex_type='amitosis', mutate_freq =500, sex_freq=500,random_mating=False,strides=1)


save_object(sf_5.sex_gen, 'Contr2_P45_SF_SEX_GEN_E500')
save_object(sf_5.sex_mean_fit, 'Contr2_P45_SF_SEX_POP_MFIT_E500')

save_object(sf_5.mfit_before_mut, 'Contr2_P45_SF_MFIT_BF_MUT_E500')

save_object(sf_5.germ_mutations, 'Contr2_P45_SF_Germ_MT_E500')
save_object(sf_5.soma_mutations, 'Contr2_P45_SF_Soma_MT_E500')

save_object(sf_5.slope_list_1, 'Contr2_P45_SF_100G_SP_E500')
save_object(sf_5.slope_list_2, 'Contr2_P45_SF_500G_SP_E500')
save_object(sf_5.slope_list_3, 'Contr2_P45_SF_1KG_SP_E500')
save_object(sf_5.slope_list_4, 'Contr2_P45_SF_2KG_SP_E500')
save_object(sf_5.slope_list_5, 'Contr2_P45_SF_5KG_SP_E500')
save_object(sf_5.slope_list_6, 'Contr2_P45_SF_10KG_SP_E500')
