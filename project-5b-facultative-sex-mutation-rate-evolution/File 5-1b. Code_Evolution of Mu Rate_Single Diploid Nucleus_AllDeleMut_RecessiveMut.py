...
class Populations(object):
    ...
    def __init__(self,nReps,nInds,nLoci,ploidy=45, genomic_mu=0.1, selcoef=0.1, ctrl_nLoci_lower = 10, ctrl_nLoci_upper = 10,\
        ...
        self.ctrl_eff_lower = ctrl_eff_lower
        self.ctrl_eff_upper = ctrl_eff_upper
    ...
    def calculate_mu(ctrl_upper, ctrl_lower, upper_eff, lower_eff, mu):
        ...
        sm_ws_upper = ctrl_upper.astype('float').copy()
        sm_ws_upper[ctrl_upper !=2 ] = 1 
        sm_ws_upper[ctrl_upper ==2 ] = 1 + upper_eff

        sm_ws_lower = ctrl_lower.astype('float').copy()
        sm_ws_lower[ctrl_lower !=2 ] = 1 
        sm_ws_lower[ctrl_lower ==2 ] = 1- lower_eff

        sm_mu = np.prod(sm_ws_upper, axis =2)*np.prod(sm_ws_lower, axis =2)*mu
...
amito_50 =Populations(nReps = 100,nInds = 2000, nLoci = 100, ploidy= 2, genomic_mu= 0.1*2/45, selcoef=0.1, ctrl_nLoci_lower = 10, ctrl_nLoci_upper = 10,\
    ctrl_mu_lower = 0.002*2/45, ctrl_mu_upper = 0.01*2/45, ctrl_eff_lower = 0.9, ctrl_eff_upper = 0.9)

amito_50.simulateNsave('Fit_RME100_SgP2Nucl_N2K_Dele_MuEvo_RecessiveModMut.csv', 20*1000, model ='WF', asex_type='mitosis',sex_freq=100,random_mating=True,strides=1)

save_object(amito_50.total_sm_mu, 'RME100_SgP2Nucl_N2K_Dele_Total_SM_MU_RecessiveModMut')
save_object(amito_50.total_pop_mfit, 'RME100_SgP2Nucl_N2K_Dele_Total_Pop_MFit_RecessiveModMut')
save_object(amito_50.total_fit_var, 'RME100_SNP2_N2K_Dele_Total_Pop_Fit_Var_RecessiveModMut')
save_object(amito_50.total_mu_var, 'RME100_SNP2_N2K_Dele_Total_SM_Mu_Var_RecessiveModMut')
save_object(amito_50.total_covariance, 'RME100_SNP2_N2K_Dele_Covariance_FitvsMu_RecessiveModMut')

save_object(amito_50.sm_ctrl_upper, 'RME100_SgP2Nucl_N2K_Dele_SM_Ctrl_Upper_RecessiveModMut')
save_object(amito_50.sm_ctrl_lower, 'RME100_SgP2Nucl_N2K_Dele_SM_Ctrl_Lower_RecessiveModMut')
