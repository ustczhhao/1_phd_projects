...
class Populations(object):
    ...
    def make_gametes(self, parents):
        ...
        return gametes_bene, gametes_dele
    ...
    def make_zygotes(self, random_mating=False):
        ...
        zy_ctrl_upper = self.sm_ctrl_upper[rReps, parents,]
        zy_ctrl_lower = self.sm_ctrl_lower[rReps, parents,]
...
save_object(amito_50.total_sm_mu_dele, 'RME100M_P2SN_N2K_Bene01_Total_SM_MU_Dele_OnlyFitLociRecom')
save_object(amito_50.total_pop_mfit, 'RME100M_P2SN_N2K_Bene01_Total_Pop_MFit_OnlyFitLociRecom')

save_object(amito_50.total_fit_var, 'RME100M_P2SN_N2K_Bene01_Total_Pop_Fit_Var_OnlyFitLociRecom')
save_object(amito_50.total_mu_dele_var, 'RME100M_P2SN_N2K_Bene01_Total_SM_DeleMu_Var_OnlyFitLociRecom')
save_object(amito_50.total_dele_covariance, 'RME100M_P2SN_N2K_Bene01_Covariance_FitvsDeleMu_OnlyFitLociRecom')

save_object(amito_50.sm_ctrl_upper, 'RME100M_P2SN_N2K_Bene01_SM_Ctrl_Upper_OnlyFitLociRecom')
save_object(amito_50.sm_ctrl_lower, 'RME100M_P2SN_N2K_Bene01_SM_Ctrl_Lower_OnlyFitLociRecom')
