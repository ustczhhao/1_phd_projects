...
amito_50.simulateNsave('Fit_ReceMod_RME100M_P2SN_N2K_Bene01_MuEvo_200207.csv', 20*1000, model ='WF', asex_type='mitosis',sex_freq=100,random_mating=True,strides=1)


save_object(amito_50.total_sm_mu_dele, 'ReceMod_RME100M_P2SN_N2K_Bene01_Total_SM_MU_Dele_200207')
save_object(amito_50.total_pop_mfit, 'ReceMod_RME100M_P2SN_N2K_Bene01_Total_Pop_MFit_200207')

save_object(amito_50.total_fit_var, 'ReceMod_RME100M_P2SN_N2K_Bene01_Total_Pop_Fit_Var_200207')
save_object(amito_50.total_mu_dele_var, 'ReceMod_RME100M_P2SN_N2K_Bene01_Total_SM_DeleMu_Var_200207')
save_object(amito_50.total_dele_covariance, 'ReceMod_RME100M_P2SN_N2K_Bene01_Cov_FitvsDeleMu_200207')

save_object(amito_50.sm_ctrl_upper, 'ReceMod_RME100M_P2SN_N2K_Bene01_SM_Ctrl_Upper_200207')
save_object(amito_50.sm_ctrl_lower, 'ReceMod_RME100M_P2SN_N2K_Bene01_SM_Ctrl_Lower_200207')
