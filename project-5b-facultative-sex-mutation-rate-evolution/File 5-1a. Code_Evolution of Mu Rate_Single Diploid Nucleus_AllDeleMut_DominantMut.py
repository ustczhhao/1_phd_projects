...
class Populations(object):
    ...
    def calculate_mu(ctrl_upper, ctrl_lower, upper_eff, lower_eff, mu):
        ...
        sm_ws_upper[ctrl_upper !=0 ] = 1 + upper_eff
        sm_ws_upper[ctrl_upper ==0 ] = 1

        sm_ws_lower = ctrl_lower.astype('float').copy()
        sm_ws_lower[ctrl_lower !=0 ] = 1 - lower_eff
        sm_ws_lower[ctrl_lower ==0 ] = 1
...
amito_50.simulateNsave('Fit_RME10_SgP2Nucl_N2K_Dele_MuEvo_DominantModMut.csv', 20*1000, model ='WF', asex_type='mitosis',sex_freq=10,random_mating=True,strides=1)

save_object(amito_50.total_sm_mu, 'RME10_SgP2Nucl_N2K_Dele_Total_SM_MU_DominantModMut')
save_object(amito_50.total_pop_mfit, 'RME10_SgP2Nucl_N2K_Dele_Total_Pop_MFit_DominantModMut')
save_object(amito_50.total_fit_var, 'RME10_SNP2_N2K_Dele_Total_Pop_Fit_Var_DominantModMut')
save_object(amito_50.total_mu_var, 'RME10_SNP2_N2K_Dele_Total_SM_Mu_Var_DominantModMut')
save_object(amito_50.total_covariance, 'RME10_SNP2_N2K_Dele_Covariance_FitvsMu_DominantModMut')

save_object(amito_50.sm_ctrl_upper, 'RME10_SgP2Nucl_N2K_Dele_SM_Ctrl_Upper_DominantModMut')
save_object(amito_50.sm_ctrl_lower, 'RME10_SgP2Nucl_N2K_Dele_SM_Ctrl_Lower_DominantModMut')
